                            ...
                            <form name="my-form" onsubmit="return validform()" action="addNewStudent.jsp" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 offset-md-4">
                                        ...
                                        <button type="submit" class="btn btn-primary" onclick="openCity(event,'London')">Update</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<section>
  ...
  <br>
   <div class="tbl-content">
    ...
    <hr class="new1">
  <center><h5>Note: Any errors occur then contact Shashank VS.
Designed & Developed by Shashank VS</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @ Shashank VS : 2021</h5></center> 
  <hr class="new1">
<br>
</body>
</html>